...
import { setColor, setMode } from '../../redux/themeSlice'
...
const ThemeMenu = () => {
  ...
  const setModeAction = (mode) => {
    const action = setMode(mode.class)
    setcurrMode(mode.id)
  ...
  const setColorAction = (color) => {
    const action = setColor(color.class)
        ...
        <div className="theme-menu__select">
          ...
          <ul className="mode-list">
            {mode_settings.map((item, index) => (
              <li key={index} onClick={() => setModeAction(item)}>
                <div
        ...
        <div className="theme-menu__select">
          ...
          <ul className="mode-list">
            {color_settings.map((item, index) => (
              <li key={index} onClick={() => setColorAction(item)}>
                <div
                  className={`mode-list__color ${item.background} ${
